...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_update_existent_recipe_user_returns_error(self):
    ...
    def test_create_tag_while_updating_recipe(self):
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        for ingredient in payload["ingredients"]:
            ...
            self.assertTrue(exists)
        ingredients_all = Ingredient.objects.filter(user=self.user)
        self.assertEqual(ingredients_all.count(), 2)
    ...
    def test_assign_existing_ingredient_when_updating_recipe(self):
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title="Thai Veggy Curry")
        r2 = create_recipe(user=self.user, title="Auberge with Onion")
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title="Apple Pie")
        r2 = create_recipe(user=self.user, title="Italian Pasta")
        ing1 = Ingredient.objects.create(user=self.user, name="Apple")
        ing2 = Ingredient.objects.create(user=self.user, name="Macaroni")
        r1.ingredients.add(ing1)
        r2.ingredients.add(ing2)
        r3 = create_recipe(user=self.user, title="Filet Mignon")
